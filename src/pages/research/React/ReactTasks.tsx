...
const ReactTasks: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTasksContent = async () => {
      try {
        ...
        const response = await fetch('/REACTDOCS/questionsandtasks.mdx');
  ...
  return (
    <section id="tasks" className="p-6 border rounded-lg bg-slate-800/40 border-amber-500/30">
      <h2 className="mb-4 text-2xl font-semibold text-amber-400">Задачи и Вопросы по React</h2>
