Тема #14 (Node.js/Express): Объекты Запроса (req) и Ответа (res) в Express
...
Объекты req и res в Express — это расширенные и удобные версии нативных объектов модуля http. Они предоставляют простой доступ к данным запроса (params, query, body (с middleware), headers) и удобные методы для формирования и отправки ответа (send, json, status, set). Понимание этих объектов и их методов — основа написания обработчиков маршрутов и middleware в Express.
